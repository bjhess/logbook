defmodule Logbook.Book do
  ...
  """
  def list_logs do
    Repo.all(from l in Log, order_by: [desc: l.id])
  end
  ...
  def subscribe do
    Phoenix.PubSub.subscribe(Logbook.PubSub, "logs")
  end

  defp broadcast({:error, _reason} = error, _event), do: error
  defp broadcast({:ok, log}, event) do
    Phoenix.PubSub.broadcast(Logbook.PubSub, "logs", {event, log})
    {:ok, log}
  end
end
